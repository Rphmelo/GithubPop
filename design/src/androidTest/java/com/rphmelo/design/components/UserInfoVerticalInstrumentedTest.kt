...
class UserInfoVerticalInstrumentedTest {

    @get:Rule
    val viewTest: ViewTestRule<UserInfoVertical> = ViewTestRule(R.layout.test_user_info_vertical)

    @Test
    fun givenUserInfoVerticalIsShowing_whenSetTitleAndBody_thenShowTheGivenTexts() {
        val userName = "google"
        val fullName = "google chrome"
        viewTest.runOnMainSynchronously(object : ViewTestRule.Runner<UserInfoVertical> {
            override fun run(view: UserInfoVertical?) {
